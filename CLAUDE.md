...
- **MVVM**: ReactiveUI
- **Replay Parsing**: FortniteReplayReader 3.0.5-botornot (patched local build from pinned upstream `2fc699e`, including replay-frame timestamps, safe-zone phase projection, recorder reconciliation, and Fortnite 41.00 decoder fixes)
