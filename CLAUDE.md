...
- **MVVM**: ReactiveUI
- **Replay Parsing**: FortniteReplayReader 3.0.12-botornot (patched local build from pinned upstream `2fc699e`, including replay-frame timestamps, safe-zone phase projection, recorder reconciliation, Fortnite 41.00 decoder fixes, selective summary-read hooks, and replay read optimizations)
